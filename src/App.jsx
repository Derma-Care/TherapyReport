...
import appLogo from "./assets/Kinetixwhitelogo.png";
...
function App() {
  ...
  const hospitalName =
    hospitalData?.name || hospitalData?.clinicName || "PhysioElite";
      ...
      {splashVisible && (
        <div
          style={{
            ...
            background:
              "linear-gradient(160deg, #0a0f1e 0%, #0d1527 55%, #091018 100%)",
        ...
        >
          ...
          <div
            style={{
              display: "flex",
              gap: 7,
              animation: "sp-fade-up 0.6s ease 0.7s both",
            }}
          >
            {[0, 1, 2].map((i) => (
              <div
